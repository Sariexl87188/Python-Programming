...
def calculateage():
    ...
    Label(text=f"{nameValue.get()}Your age is {age}",font=30).place(x=30,y=500)
...
Button(text="Calculate Age",font=20,bg="black",fg="white",width=11,height=2,command=calculateage).place(x=30,y=450)
