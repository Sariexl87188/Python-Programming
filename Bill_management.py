...
Label(f,text="Menu",font=("Gabriola",40,"bold"),fg="black",bg="green").place(x=80,height=370)

Label(f,font=("Lacida Calligraphy",15,"bold"),text="Dosa....................Rs.60/plate",fg="black",bg="green").place(x=10,y=80)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Cookies.................Rs.30/plate",fg="black",bg="green").place(x=10,y=110)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Tea.....................Rs.7/plate",fg="black",bg="green").place(x=10,y=140)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Coffee..................Rs.15/plate",fg="black",bg="green").place(x=10,y=170)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Juice...................Rs.30/plate",fg="black",bg="green").place(x=10,y=200)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Pancake.................Rs.20/plate",fg="black",bg="green").place(x=10,y=230)
Label(f,font=("Lacida Calligraphy",15,"bold"),text="Eggs....................Rs.7/plate",fg="black",bg="green").place(x=10,y=260)
...
entry_pancakes=Entry(f1,font=("aria",20,"bold"),textvariable=pancake,bd=6,width=8,bg="lightpink")
entry_eggs=Entry(f1,font=("aria",20,"bold"),textvariable=egg,bd=6,width=8,bg="lightpink")
